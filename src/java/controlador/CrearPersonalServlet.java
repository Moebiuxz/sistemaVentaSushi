...
public class CrearPersonalServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String nombre, rut, apellido, tipo;
            int tipofin;
            
            rut = request.getParameter("txtRut");
            nombre = request.getParameter("txtNombre");
            apellido = request.getParameter("txtApellido");
            tipo = request.getParameter("cboTipoProducto");
            tipofin = Integer.parseInt(tipo);
            
            Personal p = new Personal(1, rut, nombre, apellido, tipofin, 1, 1);
            DAO dd = new DAO();
