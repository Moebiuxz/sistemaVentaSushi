...
INSERT INTO cliente (cliente_fono, cliente_nombre, cliente_apellido, cliente_estado) VALUES ('555','555','555',''),('null','Alvaro','Bunster',''),('3456','1adas','asdasda',''),('3466','sadasd','asdasdas','');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO personal (personal_id, personal_rut, personal_nombre, personal_apellidos, personal_tipo, personal_usuario, personal_estado) VALUES (1,'admin','Admin','Admin',2,1,''),(2,'11-1','Luis','Martinez',2,2,'');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO producto (producto_id, producto_nombre, producto_precio, producto_tipo, producto_estado) VALUES (1,'nada',0,1,'');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO promocion (promocion_id, promocion_nombre, promocion_descueto, promocion_estado) VALUES (1,'nada',0,'');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO respaldo (respaldo_id, respaldo_fecha, respaldo_hora, respaldo_tipo) VALUES (1,'2016-04-30','03:10:52','0'),(2,'2016-04-30','03:28:40','0'),(3,'2016-04-30','03:28:41','0'),(4,'2016-04-30','03:28:42','0');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO usuario (usuario_id, usuario_nombre, usuario_clave, usuario_tipo, usuario_estado) VALUES (1,'admin','º0U’\î …ôw\ænw\×\ï',1,''),(2,'Luis',';2ÿŒG \0\Ý~–\Ï5J',2,'');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE venta (
